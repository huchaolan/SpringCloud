-- 类目
create table `springcloud_spell`.`product_category` (
...
-- 商品
create table `springcloud_spell`.`product_info` (
...
INSERT INTO `springcloud_spell`.`product_info` (`product_id`, `product_name`, `product_price`, `product_stock`, `product_description`, `product_icon`, `product_status`, `category_type`, `create_time`, `update_time`)
VALUES
...
-- 订单商品
create table `springcloud_spell`.`order_detail` (
...
-- 用户
CREATE TABLE `springcloud_spell`.`user_info` (
